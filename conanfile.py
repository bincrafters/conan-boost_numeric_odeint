...
class BoostNumeric_OdeintConan(ConanFile):
    ...
    version = "1.66.0"
    url = "https://github.com/bincrafters/conan-boost-numeric_odeint"
    ...
    requires = (
        ...
        "boost_compute/1.66.0@bincrafters/testing",
        ...
        "boost_mpi/1.66.0@bincrafters/testing",
        "boost_mpl/1.66.0@bincrafters/testing",
        "boost_multi_array/1.66.0@bincrafters/testing",
        ...
        "boost_units/1.66.0@bincrafters/testing",
